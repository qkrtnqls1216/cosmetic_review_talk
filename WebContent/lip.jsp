    	...
    	%>
			<div>
				<ul class="skinlist">
					<li>
						<a href="list.jsp">
							<img src="images/<%=rs.getString("lipName") %>.png">
							<dl>
								<dt><%=rs.getString("lipName") %></dt>
								<dd>용량:<%=rs.getString("lipMl") %><br>가격:<%=rs.getString("lipPrice") %><br><%=rs.getString("lipBrand") %></dd>
							</dl>
						</a>
					</li>
				</div>

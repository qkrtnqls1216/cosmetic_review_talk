...
String sql="select* from boybase";
    	...
    	%>
			<div>
				<ul class="skinlist">
					<li>
						<a href="list.jsp">
							<img src="images/<%=rs.getString("boybaseName") %>.png">
							<dl>
								<dt><%=rs.getString("boybaseName") %></dt>
								<dd>용량:<%=rs.getString("boybaseMl") %><br>가격:<%=rs.getString("boybasePrice") %><br><%=rs.getString("boybaseBrand") %></dd>
							</dl>
						</a>
					</li>
				</div>

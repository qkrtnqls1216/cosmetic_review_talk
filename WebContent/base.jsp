    	...
    	%>
			<div>
				<ul class="skinlist">
					<li>
						<a href="list.jsp">
							<img src="images/<%=rs.getString("baseName") %>.png">
							<dl>
								<dt><%=rs.getString("baseName") %></dt>
								<dd>용량:<%=rs.getString("baseMl") %><br>가격:<%=rs.getString("basePrice") %><br><%=rs.getString("baseBrand") %></dd>
							</dl>
						</a>
					</li>
				</div>

    	...
    	%>
			<div>
				<ul class="skinlist">
					<li>
						<a href="list.jsp">
							<img src="images/<%=rs.getString("boylipName") %>.png">
							<dl>
								<dt><%=rs.getString("boylipName") %></dt>
								<dd>용량:<%=rs.getString("boylipMl") %><br>가격:<%=rs.getString("boylipPrice") %><br><%=rs.getString("boylipBrand") %></dd>
							</dl>
						</a>
					</li>
				</div>

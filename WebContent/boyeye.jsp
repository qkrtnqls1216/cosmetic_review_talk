    	...
    	%>
			<div>
				<ul class="skinlist">
					<li>
						<a href="list.jsp">
							<img src="images/<%=rs.getString("boyeyeName") %>.png">
							<dl>
								<dt><%=rs.getString("boyeyeName") %></dt>
								<dd>용량:<%=rs.getString("boyeyeMl") %><br>가격:<%=rs.getString("boyeyePrice") %><br><%=rs.getString("boyeyeBrand") %></dd>
							</dl>
						</a>
					</li>
				</div>
